...
<section id="billboard" class="position-relative d-flex align-items-center py-5 bg-light-gray"
    style="background-image: url(images/banner-image-bg.png); background-size: cover; background-repeat: no-repeat; background-position: center; height: 800px;">
...
<section id="best-selling-items" class="position-relative padding-large ">
    <div class="container">
        <div class="section-title d-md-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('products.index') }}" class="btn">View All</a>
        </div>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="card position-relative p-4 border rounded-3">
                        ...
                        <img src="{{ asset('images/' . $product['image_url']) }}" class="img-fluid shadow-sm" alt="product item">
                        <h6 class="mt-4 mb-0 fw-bold"><a href="index.html">{{ $product['name'] }}</a></h6>
            ...
            <div class="col-md-6 mb-4 mb-lg-0 col-lg-3">
                <div class="featured border rounded-3 p-4">
                    ...
                    <div class="items-lists">
                        @foreach($randomProducts->shuffle()->take(3) as $product)
                        <div class="item d-flex">
                            <img src="{{ asset('images/' . $product['image_url']) }}" class="img-fluid shadow-sm" alt="product item">
                            <div class="item-content ms-3">
                                <h6 class="mb-0 fw-bold"><a href="index.html">{{ $product['name'] }}</a></h6>
                                <div class="review-content d-flex">
                                    <p class="my-2 me-2 fs-6 text-black-50">Stock {{ $product['stock'] }}</p>
                                    <div class="rating text-warning d-flex align-items-center">
                                        <svg class="star star-fill">
